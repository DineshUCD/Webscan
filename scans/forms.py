...
class ScanForm(forms.ModelForm):
    class Meta:
        model  = Scan
        fields = [ 'uniform_resource_locator', 'team_id' ]
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Override the IntegerField in the Form to ChoiceField and pass the Integer in the tuple or the first argument to the Scan Model team_id.
        self.fields['team_id'] = forms.ChoiceField(required=False, label="*Optional* Upload to Team App on Threadfix", choices=CHOICES)
